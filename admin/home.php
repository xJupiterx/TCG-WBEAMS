      ...
      <div class="row">
          ...
          <div class="small-box bg-green">
            <div class="inner">
               <?php
                ...
                $sql = "SELECT * FROM tbl_attendance WHERE status = 1";
                $query = $conn->query($sql);
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <?php
                $sql = "SELECT * FROM tbl_attendance WHERE date = '$today' AND status = 0";
                $query = $conn->query($sql);
...
<?php
  ...
  $late = array();
  for( $m = 1; $m <= 12; $m++ ) {
    $sql = "SELECT * FROM tbl_attendance WHERE MONTH(date) = '$m' AND status = 1 $and";
    $oquery = $conn->query($sql);
    array_push($ontime, $oquery->num_rows);

    $sql = "SELECT * FROM tbl_attendance WHERE MONTH(date) = '$m' AND status = 0 $and";
