    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                  	<label for="break_time_out" class="col-sm-3 control-label">Break Time Out</label>

                  	<div class="col-sm-9">
                  		<div class="bootstrap-timepicker">
                    		<input type="text" class="form-control timepicker" id="break_time_out" name="break_time_out">
                    	</div>
                  	</div>
                </div>

                <div class="form-group">
                    <label for="break_time_in" class="col-sm-3 control-label">Break Time In</label>

                    <div class="col-sm-9">
                      <div class="bootstrap-timepicker">
                        <input type="text" class="form-control timepicker" id="break_time_in" name="break_time_in">
                      </div>
                    </div>
                </div>
                <div class="form-group">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                  	<label for="edit_break_time_out" class="col-sm-3 control-label">Break Time Out</label>

                  	<div class="col-sm-9">
                  		<div class="bootstrap-timepicker">
                    		<input type="text" class="form-control timepicker" id="edit_break_time_out" name="edit_break_time_out">
                    	</div>
                  	</div>
                </div>

                <div class="form-group">
                    <label for="edit_break_time_in" class="col-sm-3 control-label">Break Time In</label>

                    <div class="col-sm-9">
                      <div class="bootstrap-timepicker">
                        <input type="text" class="form-control timepicker" id="edit_break_time_in" name="edit_break_time_in">
                      </div>
                    </div>
                </div>
                <div class="form-group">
