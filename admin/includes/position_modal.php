    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                  <label for="salary_grade" class="col-sm-3 control-label">Salary Grade</label>
                ...
                <div class="form-group">
                  <label for="step_increment" class="col-sm-3 control-label">Step Increment</label>

                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="step_increment" name="step_increment" required>
                  </div>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                  <label for="edit_salary_grade" class="col-sm-3 control-label">Salary Grade</label>

                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="edit_salary_grade" name="salary_grade" required>
                  </div>
                </div>

                <div class="form-group">
                  <label for="edit_step_increment" class="col-sm-3 control-label">Step Increment</label>

                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="edit_step_increment" name="step_increment" required>
                  </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_monthly_salary" name="monthly_salary">
                    </div>
                </div>
          	</div>
          	<div class="modal-footer">
